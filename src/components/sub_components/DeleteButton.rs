...
impl Component for DeleteButton {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <svg style={ format!("{init_style} transform: {} {} {}", rz, ry, rx, init_style = self.style.inline() )} onclick={ ctx.props().onclick.clone() } jrole="Judit_DeleteButton" width="24px" height="24px" stroke_width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000">
